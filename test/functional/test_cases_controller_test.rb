...
class TestCasesControllerTest < ActionController::TestCase
  ...
  test "should create test_case" do
    assert_difference('TestCase.count') do
      post :create, test_case: { description: @test_case.description, name: @test_case.name, result: @test_case.result }
    end
  ...
  test "should update test_case" do
    put :update, id: @test_case, test_case: { description: @test_case.description, name: @test_case.name, result: @test_case.result }
    assert_redirected_to test_case_path(assigns(:test_case))
  end
